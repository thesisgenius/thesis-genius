...
const ForumDashboard = () => {
  ...
  const refreshPosts = async (newPostData) => {
    try {
      ...
      if (
        newPostData &&
        (!newPostData.id || newPostData.id.startsWith("temp"))
      ) {
