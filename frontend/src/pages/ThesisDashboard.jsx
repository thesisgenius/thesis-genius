...
// React callback for input handling
    ...
    const handleAddBodyPage = async (thesisId) => {
        try {
            ...
            const nextPageNumber = (bodyPages.length > 0 ? Math.max(...bodyPages.map(p => p.page_number)) + 1 : 1);
    ...
    const generateLivePreview = (thesisData, coverPageData, abstractData, bodyPagesData) => {
        let pageNumber = 1;
        const totalPages = 1 + (abstractData ? 1 : 0) + (bodyPagesData.length || 1) + 1; // Total pages excluding cover
    ...
    `;
        ...
        const bodySections = bodyPagesData.map(
            (page) => `
                    ...
                    <div style={editorPaneStyle}>
                                ...
                                {tableOfContents.map((entry, index) => (
                                    <div key={index}>
                                        <input
                                            ...
                                            style={inputStyle}
                                            onChange={(e) => handleTOCChange(index, "section_title", e.target.value)}
                                        />
                                        <input
                                            type="number"
                                            value={entry.page_number}
                                            style={inputStyle}
                                            onChange={(e) => handleTOCChange(index, "page_number", Number(e.target.value))}
                                        />
                                    </div>
                                ))}
                            </div>
                        ...
                        {selectedSection === "Cover Page" && (
                            <div style={inputGroupStyle}>
                                ...
                                <input
                                    ...
                                    style={inputStyle}
                                    onChange={(e) => handleCoverPageChange("author", e.target.value)}
                                />
                                ...
                                <input
                                    ...
                                    style={inputStyle}
                                    onChange={(e) => handleCoverPageChange("affiliation", e.target.value)}
                                />
                                ...
                                <input
                                    ...
                                    style={inputStyle}
                                    onChange={(e) => handleCoverPageChange("course", e.target.value)}
                                />
                                ...
                                <input
                                    ...
                                    style={inputStyle}
                                    onChange={(e) => handleCoverPageChange("instructor", e.target.value)}
                                />
                                ...
                                <input
                                    ...
                                    style={inputStyle}
                                    onChange={(e) => handleCoverPageChange("due_date", e.target.value)}
                                />
                            </div>
                        )}
                        ...
                        {selectedSection === "Body" && (
                            <div style={inputGroupStyle}>
                                ...
                                {bodyPages.map((page, index) => (
                                    <div key={page.id || index} style={{marginBottom: "12px"}}>
                                        ...
                                        <textarea
                                            ...
                                            value={page.body || ""}
                                            style={textareaStyle}
                                            onChange={(e) => handleBodyPageChange(thesisId, page.id, e.target.value)}
                                        />
                                        <button
                                ...
                                {/* Add New Page Button */}
                                <button style={addButtonStyle} onClick={() => handleAddBodyPage(thesisId)}>
                                    + Add New Page
                                </button>
                            </div>
                        )}
